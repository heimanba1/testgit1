...
<body>
<form action="${pageContext.request.contextPath }/industryAction!updateIndustry.go" name="myForm" method="post" enctype="multipart/form-data">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="d5d4d4" >
  <tr>
    <td height="22" colspan="4" background="images/bg.gif" bgcolor="#FFFFFF" class="STYLE3"><div align="center">更新课程页面</div></td>
  </tr>
  <tr>
    <td colspan="4" bgcolor="#FFFFFF" class="STYLE1"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
     <s:set value="industry" var="getIndustry"></s:set>
     <tr>
      ...
      <tr>
        ...
        <td height="35" colspan="1" class="STYLE1"><div align="left">
        <input type="hidden" name="industry.i_id" value="${getIndustry.i_id }">
          <input type="text" name="industry.i_title" required="required" value="${getIndustry.i_title}" style="width:300px; height:17px; font-size:12px; border:solid 1px #ccc; " />
        </div></td>
        </tr>
        <tr>
        <td width="142" height="35" class="STYLE1" nowrap="nowrap"><div align="left">课程价格：<br /></div></td>
        <td height="35" colspan="1" class="STYLE1"><div align="left">
          <input type="text" name="industry.i_price" required="required" value="${getIndustry.i_price }"  style="width:300px; height:17px; font-size:12px; border:solid 1px #ccc; " />
        </div></td>
        </tr>
         <tr>
        <td width="142" height="35" class="STYLE1" nowrap="nowrap"><div align="left">课程来源：<br /></div></td>
        <td height="35" colspan="1" class="STYLE1"><div align="left">
          <input type="text" name="industry.i_source" required="required" value="${getIndustry.i_source }"  style="width:300px; height:17px; font-size:12px; border:solid 1px #ccc; " />
        </div></td>
        </tr>
         <tr>
        <td width="142" height="35" class="STYLE1" nowrap="nowrap"><div align="left">课程联系方式：<br /></div></td>
        <td height="35" colspan="1" class="STYLE1"><div align="left">
          <input type="text" name="industry.i_contact" required="required" value="${getIndustry.i_contact}"  style="width:300px; height:17px; font-size:12px; border:solid 1px #ccc; " />
        </div></td>
        </tr>
        <tr>
        <td width="142" height="35" class="STYLE1" nowrap="nowrap"><div align="left">添加时间：<br /></div></td>
        <td height="35" colspan="1" class="STYLE1"><div align="left">
         <input class="Wdate" name="industry.i_time" required="required" value="${getIndustry.i_time }" type="text" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })"> <font color=red>&lt;- 点我弹出日期</font>
        </div></td>
        </tr>
        <tr>
        ...
        <td height="35" colspan="1" class="STYLE1"><div align="left">
          <textarea name="industry.i_content"  style=" width:600px; height:200px;">${getIndustry.i_content }</textarea>
